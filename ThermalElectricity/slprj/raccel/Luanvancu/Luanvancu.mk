...
MODEL                  = Luanvancu
MODULES                = rt_matrx.c rt_printf.c rt_logging.c Luanvancu.c Luanvancu_capi.c Luanvancu_data.c Luanvancu_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
...
S_FUNCTIONS            = rtiostream_utils.c AdsRead.c AdsWrite.c
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Luanvancu_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\Luanvancu
