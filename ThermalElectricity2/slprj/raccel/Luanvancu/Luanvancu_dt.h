...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . aoca5q4ss2
) , 0 , 0 , 36 } , { ( char_T * ) ( & rtDW . e1t4qyehrf . LoggedData ) , 11 ,
0 , 16 } } ; static DataTypeTransitionTable rtBTransTable = { 2U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . SliderGain_gain ) , 0 , 0 , 122 } , { ( char_T * ) ( &
